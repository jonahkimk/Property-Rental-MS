...
export default function LandlordMessages() {
  ...
  const handleSend = async () => {
    ...
    if (!recipientId)        { toast.error('Please select a tenant.'); return; }
    setSaving(true);
    try {
      await api.post('/messages', { subject, body, recipient_id: recipientId });
  ...
  return (
    <div className="page-wrapper">
      ...
      <div className="page-content">
        <TopBar title="Messages" subtitle="Conversations with your tenants" />
                ...
                {loading ? (
                  ...
                  <div className="px-5">
                    <EmptyState icon={MessageSquare} title="No conversations yet"
                      description="Start a conversation by messaging a tenant."
                      action={
              ...
              <div className="card p-5 flex flex-col flex-1 overflow-hidden">
                ...
                <div className="flex items-center gap-3 pb-4 mb-4 border-b border-slate-200 dark:border-slate-700 shrink-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-slate-400">
                      {activeThread.sender_name} → {activeThread.recipient_name || 'Tenant'}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto space-y-3 pr-1 min-h-0">
                  {threadLoading ? (
                    ...
                    threadMsgs.map(msg => {
                      const isMine = msg.sender_id === activeThread.recipient_id;
                      return (
      ...
      <Modal open={modal} onClose={() => setModal(false)}
        ...
        <div className="space-y-4">
          ...
          <div className="form-group">
            ...
            <input className="input" placeholder="e.g. Rent reminder"
              value={subject}
